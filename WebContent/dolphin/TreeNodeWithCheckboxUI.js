/**
 * @class Ext.tree.TreeNodeWithCheckboxUI
 ...
 *
 * usage:
 *    just add attribute  baseAttrs: { uiProvider: Ext.ux.TreeNodeWithCheckboxUI }  to tree's loader
 *
 * for example:
 *
 ...
 *			baseAttrs: { uiProvider: Ext.ux.TreeNodeWithCheckboxUI } //add uiProvider attribute
 *		}),
...
Ext.tree.TreeNodeWithCheckboxUI = function() {
	//'multiple': multiple check model; 'single': single check model; 'cascade':cascade check model
	this.checkModel = 'multiple';
	//only leaf node has checkbox
	this.onlyLeafCheckable = false;
	
	Ext.tree.TreeNodeWithCheckboxUI.superclass.constructor.apply(this, arguments);
};

Ext.extend(Ext.tree.TreeNodeWithCheckboxUI, Ext.tree.TreeNodeUI, {
