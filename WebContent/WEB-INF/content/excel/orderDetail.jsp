...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
    ...
    <div class="sheet">
        <table class="tb" cellspacing="0" cellpadding="0" border="0" >
        	<tr>
        		<td colspan="9" class="title">订单</td>
        	</tr>
        	<tr>
            ...
            <c:forEach items="${detailList}" var="detail" varStatus="status" >
	            <tr>
					...
					<td class="right">${detail.productNum}</td>
					<td class="right"><fmt:formatNumber value="${detail.price*detail.productNum}" type="number" pattern="#,#00.00#" /></td>
					<td>&nbsp;</td>
	            </tr>
			</c:forEach>
        </table>
