...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
	<head>
		...
		<script type="text/javascript" src="<%=ctx%>/staff/EmployeeMng.js"></script>
		<script type="text/javascript" src="<%=ctx%>/staff/EmployeeCard.js"></script>
		...
		<script type="text/javascript">
			Ext.onReady(function(){
				var mainPanel= new employee.manage.MainPanel();
