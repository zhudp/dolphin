...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
	<head>
		...
		<script type="text/javascript" src="<%=ctx%>/material/MaterialStockInDetailMng.js"></script>
		<script type="text/javascript" src="<%=ctx%>/material/MaterialStockInDetailCard.js"></script>
