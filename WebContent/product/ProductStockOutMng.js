Ext.namespace("ProductStockOut.manage");
ProductStockOut.manage.MainPanel = function(config) {
	ProductStockOut.manage.MainPanel.superclass.constructor.call(this, config);
	this.url.query = '/product/stockout!queryPaged.do';
	this.url.remove = '/product/stockout!delete.do';
	this.url.get = '/product/stockout!getProductStockOut.do';
	this.url.queryPaged = '/product/stockout!queryPaged.do';
	this.url.exportExcel ='/product/stockout!exportExcel.do';
};
Ext.extend(ProductStockOut.manage.MainPanel,Common.manage.MainPanel,{
	 ...
	 */
	getCardWin : function(){
		var cardWin = new ProductStockOut.card.Win({width : 680,height: 500,title:"产品出库管理",callbackClose:true});
